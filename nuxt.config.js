...
export default defineNuxtConfig(
    {
      ...
      //change head to useHead and also used meta if you want to
      ...
      //Above four buildModuled were used in Modules because re not used in nuxt3
                ...
                lazyRule.use.splice(idx, 1, {
                  ...
                  options: {
                    ...
                    insert: function insertAtTop(element) {
                      const parent = document.querySelector("useHead");
