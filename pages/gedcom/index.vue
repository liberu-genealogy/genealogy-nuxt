        ...
        <div class="columns is-gapless is-multiline is-mobile">
            ...
            <div class="column is-12">
                <nav class="breadcrumb mt-1 mb-0" aria-label="breadcrumbs">
                    <ul>
                        <li>
                            <a class="is-size-7 has-text-weight-medium has-text-link" href="/dashboard">
                                Home
                            </a>
                        </li>
                        <li>
                            <a class="is-size-7 has-text-weight-medium is-active">
                                Gedcoms
                            </a>
                        </li>
                    </ul>
                ...
                <div class="card has-background-white has-text-black" style="height: 500px;">
                    <div class="card-content">
                        ...
                        <div class="field import_block" v-if="!isLoading">
                            ...
                            <!-- <p class="help" :class="{ 'is-danger': $v.fileName.$error }" v-if="!$v.fileName.required">
                                Field is required
                            </p> -->
                        </div>
                        <b-progress v-if="isLoading" type="is-success" :max="total" :value="complete" show-value />
                        ...
                        <ul class="bullet_list mt-5">
                            ...
                            <li>
                                Please select a GEDCOM file exported from your desktop software or online website and click upload. It should begin to process and show imported data processing. If it stops before fully importing contact
