                ...
                <div class="card has-background-white has-text-black">
                    <div class="card-content is-flex jc--sb">
                        ...
                        <!-- <p class="is-size-4 has-text-weight-semibold">
                            ...
                            <p class="is-size-4 has-text-weight-emibold">
                                peoplesattached
                            </p>
                            <div class="is-size-7 has-text-black has-text-weight-medium mt-1">
                                <NuxtLink to="/gedcom" class="button is-size-7 is-uppercase has-text-weight-medium has-text-primary is-light mt-4">
                                    GEDCOM Import
                                </NuxtLink>
                            </div>
                        </div>
                ...
                <div class="column is-4-desktop is-6-tablet is-flex">
                    <div class="card has-background-primary has-text-centered">
                        <div class="card-content">
                            ...
                            <NuxtLink to="/subscription" class="button is-size-7 is-uppercase has-text-weight-medium has-text-primary is-light mt-4">
                                Subscribe
                            </NuxtLink>
                        </div>
                    </div>
                    <div class="card has-background-primary has-text-white">
                        <div class="card-content">
                            ...
                            <NuxtLink to="subscription" class="button is-size-7 is-uppercase has-background-white has-text-weight-medium has-text-primary is-light mt-4">
                                Upgrade Plan
                            </NuxtLink>
                        </div>
                    </div>
...
<style scoped>
    ...
    @import '~/assets/css/pedigree-chart.css';
    @import '~/assets/css/fan-chart/fan-chart.css';
    @import '~/assets/css/fan-chart/svg.css';
