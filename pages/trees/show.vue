...
import {
    coordQuad, dagConnect, dagStratify, decrossOpt, layeringSimplex, sugiyama,
} from 'd3-dag';
...
export default {
    ...
    methods: {
        ...
        collapse(d) {
            ...
            const vis_inserted_neighbors = d.neighbors.filter(n => n.visible && d.inserted_nodes.includes(n));
        ...
        update(source) {
            ...
            nodeEnter.append('circle')
                .attr('class', 'node')
                .attr('r', 1e-6)
                .style('fill', d => (this.is_extendable(d) ? 'lightsteelblue' : '#fff'));
