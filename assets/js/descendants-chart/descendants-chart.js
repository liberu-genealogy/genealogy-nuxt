(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.WebtreesDescendantsChart = {}));
   ...
   * @type {Number}
   */
  const LAYOUT_HORIZONTAL_NODE_WIDTH  = 300;
  const LAYOUT_HORIZONTAL_NODE_HEIGHT = 80;
  const LAYOUT_VERTICAL_NODE_WIDTH    = 150;
  const LAYOUT_VERTICAL_NODE_HEIGHT   = 175;
   ...
   */
  function dataUrl(input, init = null)
  {
  ...
  class Box
  {
      ...
      constructor(orientation)
      {
          ...
          this._image = new Image$1(orientation, this._cornerRadius);
      }
  ...
  exports.DescendantsChart = DescendantsChart;
