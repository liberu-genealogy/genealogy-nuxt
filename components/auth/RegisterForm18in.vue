<template>
  <div class="login">
    <div class="box has-padding-medium">
      ...
      >
        <figure
          class="image is-24x24 logo is-clickable"
      ...
      <form class="has-margin-bottom-medium" @submit.prevent="submit()">
        <div class="field">
          ...
          <p
            class="has-text-left has-text-danger is-size-7"
            v-if="errors.has('first_name')"
          >
        ...
        <div class="field">
          <div class="control has-icons-left has-icons-right">
            ...
            <reveal-password
              ...
              :class="{
                'is-spaced': match || isSuccessful || errors.has('password'),
              }"
            ...
            <span
              v-if="(match && !errors.has('password')) || isSuccessful"
              class="icon is-small is-right has-text-success"
            >
              <fa icon="check" />
            </span>
