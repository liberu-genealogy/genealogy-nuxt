  ...
  <AuthIndex>
    <template #form>
      <ValidationObserver slim v-slot="{ handleSubmit }">
        <form @submit.prevent="handleSubmit(submit)" class="
            column
            is-6-tablet
            is-7-desktop
            is-7-widescreen
          ...
          <div class="auth-form is-gapless">
                  ...
                  <div class="field">
                    <ValidationProvider name="First Name" rules="required|min:3" v-slot="{ errors }">
                      <p class="control has-icons-left has-icons-right">
                        <input class="input is-large" type="text" :class="{ 'is-danger': errors[0] }"
            ...
            <div class="mb-5">
              <div class="field">
                <ValidationProvider v-slot="{ errors }" name="Password" vid="password" rules="required|min:8">
                  <p class="control has-icons-left has-icons-right">
                    <input class="input is-large" :class="{ 'is-danger': errors[0] }" type="password"
            ...
            <div class="mb-5">
              <div class="field">
                <ValidationProvider name="Password Confirm" rules="required|confirmed:password" v-slot="{ errors }">
                  <p class="control has-icons-left has-icons-right">
                    <input class="input is-large" :type="passwordMeta.content" :class="{ 'is-danger': errors[0] }"
            ...
            <div class="mb-5">
              <div class="field">
                <p class="control has-icons-left has-icons-right">
                  <vue-select label="title" v-model="selected_plan" :reduce="(plan) => plan.id"
                    :options="plans"></vue-select>
                ...
                <div class="column">
                  <ValidationProvider name="Terms And Conditions" :rules="{ required: { allowFalse: false } }"
                    ...
                    <label class="checkbox">
                      ...
                      Agree to
                      <NuxtLink to="/termsandconditions" class="has-text-link has-text-weight-medium">terms and
                        conditions</NuxtLink>
                    </label>
