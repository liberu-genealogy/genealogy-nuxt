            ...
            <div class="auth-form is-gapless">
                <div class="mb-5">
                    <NuxtLink to="/" class=" is-size-6 is-flex has-text-link has-text-weight-medium mb-2 ">
                        <font-awesome-icon :icon="['fas', 'angle-left']" class="mt-1 mr-2" />Back to Home
                    </NuxtLink>
                ...
                <div>
                    <p class=" is-size-6 has-text-dark has-text-centered has-text-weight-regular " >
                        ...
                        <NuxtLink to="/login" class="has-text-link has-text-weight-medium" v-text="'Sign in'">
                        </NuxtLink>
                    </p>
                </div>
                    ...
                    <div class="columns">
                        <div class="column">
                            <div class="field">
                                ...
                                <p class="control has-icons-left has-icons-right">
                                    <input class="input is-large" type="text" :class="{ 'is-danger': errors[0] }" placeholder="First name" v-model="first_name" />
                                </p>
                                <p v-if="errors[0]" class="has-text-danger p-2 is-size-7" v-text="errors[0]"> </p>
                                </ValidationProvider>
                            </div>
                        </div>
                        <div class="column">
                            <div class="field">
                                <ValidationProvider name="Last Name" v-slot="{ errors }" rules="required|min:3" >
                                <p class="control has-icons-left has-icons-right">
                                    <input class="input is-large" type="text" :class="{ 'is-danger': errors[0] }" placeholder="Last name" v-model="last_name" />
                                    <span class="icon is-small is-left">
                                    <font-awesome-icon :icon="['fas', 'user']" />
                                    </span>
                                </p>
                ...
                <!-- <div class="mb-5">
                    <div class="field">
                        ...
                        <p class="control has-icons-left has-icons-right">
                            <input class="input is-large" type="text" :class="{ 'is-danger': errors[0] }" placeholder="Email address" v-model="email" />
                            <span class="icon is-small is-left">
                            <font-awesome-icon :icon="['fas', 'envelope']" />
                            </span>
                        </p>
                ...
                <div class="mb-5">
                    <div class="field">
                        <ValidationProvider v-slot="{ errors }" name="Password" vid="password" rules="required|min:8">
                        <p class="control has-icons-left has-icons-right">
                            <input class="input is-large" :class="{ 'is-danger': errors[0] }" type="password" placeholder="Password" v-model="password" />
                            <span class="icon is-small is-left">
                            <font-awesome-icon :icon="['fas', 'lock']" />
                            </span>
                        </p>
                ...
                <div class="mb-5">
                    <div class="field">
                        ...
                        <p class="control has-icons-left has-icons-right">
                            <input class="input is-large" :type="passwordMeta.content" :class="{ 'is-danger': errors[0] }" placeholder="Confirm Password" v-model="password_confirmation" />
                            <span class="icon is-small is-left">
                            <font-awesome-icon :icon="['fas', 'lock']" />
                            </span>
                        </p>
