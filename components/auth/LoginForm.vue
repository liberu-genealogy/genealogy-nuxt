            ...
            <div>
                ...
                <div class="field">
                  <ValidationProvider name="Email" ref="email" rules="required|email" v-slot="{ errors }">
                    <p class="control has-icons-left has-icons-right">
                      <input class="input" :class="{ 'is-danger': errors[0] }" type="email" placeholder="Email address"
                        v-model="email" />
                    </p>
              ...
              <div class="mb-5">
                <div class="field">
                  <ValidationProvider name="Password" ref="password" v-slot="{ errors }" rules="required">
                    <p class="control has-icons-left has-icons-right">
                      <input class="input" :class="{ 'is-danger': errors[0] }" type="password" placeholder="Password"
                        v-model="password" />
                    </p>
              ...
              <div class="mb-5">
                <div class="columns is-mobile is-gapless">
                  ...
                  <div class="column has-text-right">
                    <NuxtLink to="/forgotpassword" class="has-text-link has-text-weight-medium">
                      Forgot password?
                    </NuxtLink>
                  </div>
                </div>
              ...
              <div>
                <p class="
                  ...
                  <NuxtLink to="/register" class="has-text-link has-text-weight-medium">
                    Register Now
                  </NuxtLink>
                </p>
              </div>
